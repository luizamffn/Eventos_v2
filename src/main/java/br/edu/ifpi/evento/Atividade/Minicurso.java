...
public class Minicurso extends Atividade implements Compravel {
	private double valor;

	public Minicurso(Long id, String nome, Evento evento, TipoAtividade tipoAtividade, EspacoFisico espacoFisico,
