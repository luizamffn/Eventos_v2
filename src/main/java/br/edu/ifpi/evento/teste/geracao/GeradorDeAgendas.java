...
public class GeradorDeAgendas {
 ...
 throws DataMenorQueAtualException, DataFimMenorQueDataInicioException,
		...
		EspacoFisico b3_sala4 = new EspacoFisico.EspacoFisicoBuilder((long) 2).descricao("B3-04").build();
		...
		EspacoFisico b3_sala10 = new EspacoFisico.EspacoFisicoBuilder((long) 3).descricao("B3-10").build();;
...
//
//		EspacoFisico patio = new EspacoFisico.EspacoFisicoBuilder((long) 4).descricao("Patio").build();;
//
