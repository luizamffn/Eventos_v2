...
//				new AtividadeCompravel(Long.valueOf(1), "python", evento, b3_sala4, dataInicial2,
//				dataFinal2, 30.00, TipoAtividadeCompravel.PALESTRA);
		...
		AtividadeCompravel atividade2 = AtividadeCompravelBuilder.builder()
				.id(Long.valueOf(2))
				.nome("android")
				.horarioInicio(dataInicial3)
				.horarioFim(dataFinal3)
				.evento(evento)
				.espacoFisico(b3_sala4)
				.getAtidadeCompravel();
...
//				dataInicial3, dataFinal3, 30.00, TipoAtividadeCompravel.PALESTRA);
		...
		EspacoFisico b3_sala10 = EspacoFisicoBuilder.builder()
				.id((long)3)
				.descricao("B3-10")
				.getEspacoFisico(); 
		...
		AtividadeCompravel atividade3 = AtividadeCompravelBuilder.builder()
				.id(Long.valueOf(3))
				.nome("python")
				.horarioInicio(dataInicial4)
				.horarioFim(dataFinal4)
				.evento(evento)
		...
		AtividadeCompravel atividade24 = AtividadeCompravelBuilder.builder()
				.id(Long.valueOf(4))
				.nome("android")
				.horarioInicio(dataInicial5)
				.horarioFim(dataFinal5)
				.evento(evento)
				.espacoFisico(b3_sala10)
				.getAtidadeCompravel();
		...
		AtividadeNaoCompravel intervalo = AtividadeNaoCompravelBuilder.builder()
				.id(Long.valueOf(6))
				.nome("intervalo")
				.horarioInicio(dataInicial6)
				.horarioFim(dataFinal6)
				.evento(evento)
				.espacoFisico(patio)
