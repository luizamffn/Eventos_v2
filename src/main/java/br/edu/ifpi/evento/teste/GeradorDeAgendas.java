...
public class GeradorDeAgendas {
	...
	public static void main(String[] args) throws DataMenorQueAtualException, DataFimMenorQueDataInicioException, AtividadeException {
		...
		Palestra atividade2 = new Palestra(Long.valueOf(2), "android", evento, b3_sala4,dataInicial3,dataFinal3, 30.00);
		...
		Palestra atividade3 = new Palestra(Long.valueOf(3),"python", evento, b3_sala10,dataInicial4,dataFinal4, 30.00);
		...
		Palestra atividade24 = new Palestra(Long.valueOf(4), "android", evento, b3_sala10,dataInicial5,dataFinal5, 30.00);
